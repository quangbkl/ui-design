...
import {View, SafeAreaView, StyleSheet, ScrollView, Slider} from 'react-native';
import {
    Item,
    Input as NBInput,
    DatePicker,
                ...
                <Modal
                    ...
                    <View style={styles.contentModal}>
                        <View style={styles.content}>
                            ...
                            <TextInput style={styles.text} placeholder="Chọn thành phố, khách sạn"/>
                        </View>
                        <Text onPress={() => setVisibleSearch(false)} whiteColor style={[styles.text, {color: BaseColor.whiteColor}]}>Hủy</Text>
                        </View>
                        
                        <ScrollView style={{ maxHeight: 300 }}>
                            <List>
                                <ListItem itemDivider>
                                    <Text bluePrimaryColor>Tìm kiếm gần đây</Text>
                                </ListItem>
                                <ListItem style={{justifyContent: 'space-between'}}>
                                    <Text>Vĩnh Phúc</Text>
                                    <Text grayColor body2>3000 khách sạn của chị Thúy</Text>
                                </ListItem>
                                <ListItem style={{justifyContent: 'space-between'}}>
                                    <Text>Hà Nội</Text>
                                    <Text grayColor body2>300 khách sạn</Text>
                                </ListItem>
                                <ListItem style={{justifyContent: 'space-between'}}>
