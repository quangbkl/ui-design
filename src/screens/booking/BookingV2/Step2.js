				...
				<View style={styles.content}>
					...
					<View style={{marginTop: -10}}>
						<View style={styles.userIn4}>
							<Text style={{fontSize: 17, fontWeight: '700'}}>(1x) Basic double room</Text>
							<View style={{flexDirection: 'row'}}>
								<View style={{flex: 40, marginTop: 8, flexDirection: 'column', justifyContent: 'space-between'}}>
									<Text style={styles.Text15}>Loại giường</Text>
									<Text style={styles.Text15}>Số khách</Text>
								</View>
								<View style={{flex: 60, marginTop: 8, flexDirection: 'column', justifyContent: 'space-between'}}>
									<Text style={styles.Text15}>1 giường đôi</Text>
									<Text style={styles.Text15}>2 khách/phòng</Text>
								</View>
							</View>
							<View style={{flexDirection: 'row'}}>
								<View style={{flex: 40, marginTop: 8, flexDirection: 'column'}}>
									<Image style={styles.image} source={{uri: 'https://kristinmateikahome.files.wordpress.com/2019/11/david-werbrouck-ohxhsg8_vn0-unsplash-edit-.jpg'}}/>
								</View>
								<View style={{flex: 60, marginTop: 8, flexDirection: 'column', justifyContent: 'flex-start'}}>
					...
					<View style={{marginTop: -10}}>
						<View style={styles.userIn4}>
							<Text style={{fontSize: 17, fontWeight: '700'}}>Chính sách khách sạn & phòng</Text>
							<View style={{marginTop: 8}}>
								<Text style={{fontSize: 15}}>Áp dụng chính sách hủy phòng</Text>
								<Text style={{fontSize: 15, marginTop: 10}}>đặt phòng này không được hoàn tiền. Thời gian hiển thị là giờ địa phương.
									Số đêm nghỉ và hạng phòng không được thay đổi</Text>
							</View>
						</View>
					</View>
					...
					<View style={{marginTop: -10}}>
						<View style={styles.userIn4}>
							<Text style={{fontSize: 17, fontWeight: '700'}}>Chi tiết đặt phòng</Text>
							<View style={{marginTop: 8}}>
					...
					<Card style={{marginTop: 0}}>
						<Text style={{fontSize: 17, fontWeight: '700', marginLeft: 15}}>Chi tiết giá</Text>
